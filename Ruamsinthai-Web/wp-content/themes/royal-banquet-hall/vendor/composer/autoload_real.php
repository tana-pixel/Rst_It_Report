...
class Luzuk_Royal_Banquet_Hall_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function luzuk_royal_banquet_hall_loadClassLoader($class)
    {
    ...
    public static function luzuk_royal_banquet_hall_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
