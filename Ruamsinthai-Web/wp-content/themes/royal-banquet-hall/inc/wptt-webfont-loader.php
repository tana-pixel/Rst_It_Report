...
if ( ! class_exists( 'Luzuk_Royal_Banquet_Hall_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Luzuk_Royal_Banquet_Hall_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Luzuk_Royal_Banquet_Hall_WPTT_WebFont_Loader( $url );
