...
class ThemePageController
{
    ...
    public static function ThemePageSubMenu()
    {
        ...
        add_submenu_page('themes.php', __('Theme Settings', 'construction-and-renovation'), __('Theme Settings', 'construction-and-renovation') . $awaiting, 'manage_options', self::GetPageSlug(), array(__CLASS__, 'ThemePageContent'), 1);
    }
