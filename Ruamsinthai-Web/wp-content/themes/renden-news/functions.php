...
function renden_thinkup_child_frontscripts() {
	...
	wp_enqueue_style( 'renden-thinkup-style-news', get_stylesheet_directory_uri() . '/style.css', array( 'thinkup-style' ), wp_get_theme()->get('Version') );
}
...
function renden_thinkup_updateoption_child_settings() {
	...
	if ( $options_child_settings != 1 ) {
		...
		$options_free['thinkup_header_styleswitch'] = 'option2';
