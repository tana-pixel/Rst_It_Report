...
//Post Style
$post_count = autlines_get_theme_mod('post_per_page',true);
...
if ( is_active_sidebar( 'main-sidebar' ) and autlines_get_theme_mod('blog_template_sidebar',true) !='disable' ) {
    $sidebar_float = autlines_get_theme_mod('blog_template_sidebar',true);
}
...
// Blog Style
$style  = autlines_get_theme_mod('blog_archive_style',true);
if($style =='default'){
    $post_style                 = 'default';
...
// Animation
$post_animation = autlines_get_theme_mod('blog_animation',true);
...
// Pagination
$pagination = autlines_get_theme_mod('blog_pagination',true);
