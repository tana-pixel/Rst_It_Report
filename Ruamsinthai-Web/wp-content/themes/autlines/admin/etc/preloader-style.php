...
if(autlines_get_theme_mod('preloader_page_show')== 'true'){
    ...
    function autlines_custom_pre_style() {
        wp_enqueue_style(
            'autlines_custom_pre_style',
            get_template_directory_uri() . '/assets/css/preloader.min.css'
        );
        $pre_circle_color = autlines_get_theme_mod( 'site_preloader_color_style_circle' );
        $pre_circle_color_shadow = autlines_get_theme_mod( 'site_preloader_color_style_circle_shadow' );
        $pre_merging_balls_color = autlines_get_theme_mod( 'site_pre_color_style_merging_balls' );
        $pre_rankle_loader_color = autlines_get_theme_mod( 'site_pre_color_style_rankle_loader' );
        $pre_rankle_heart_color = autlines_get_theme_mod( 'site_pre_color_style_heart_loader' );
        $pre_rankle_heart_save_color = autlines_get_theme_mod( 'site_preloader_body_style' );
        $pre_spinner_color = autlines_get_theme_mod( 'site_pre_color_style_spinner' );
        $pulsating_circle_color = autlines_get_theme_mod('site_preloader_pulsating_circle');
        $custom_css = " 
        ...
        ";
        wp_add_inline_style( 'autlines_custom_pre_style', $custom_css );
    }
    add_action( 'wp_enqueue_scripts', 'autlines_custom_pre_style' );
