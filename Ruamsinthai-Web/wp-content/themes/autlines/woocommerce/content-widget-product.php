...
<li>
	...
	<div class="product_thumbnail"><?php echo autlines_wp_kses($product->get_image());?></div>
	<div class="product_summary">
        ...
        <?php endif; ?>
		<div class="product-price"><?php echo autlines_wp_kses($product->get_price_html()); ?></div>
