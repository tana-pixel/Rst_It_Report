...
<div id="main-navigation" class="clear-fix" style="background: <?php  echo esc_attr( graceful_trend_blog_options( 'main_navigation_bg' ) ) ?>;" data-fixed="<?php echo esc_attr( graceful_options( 'main_navigation_fixed' ) ); ?>">
