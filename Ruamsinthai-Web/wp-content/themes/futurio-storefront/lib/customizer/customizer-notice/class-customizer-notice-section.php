<?php
/**
 * Futurio Storefront Customizer Notification Section Class.
 *
 * @package Futurio
 */

/**
 * Futurio_Storefront_Customizer_Notice_Section class
 */
class Futurio_Storefront_Customizer_Notice_Section extends WP_Customize_Section {
	/**
	...
	public function json() {
		...
		foreach ( $futurio_storefront_recommended_plugins as $slug => $plugin_opt ) {
			...
			$futurio_storefront_recommended_plugin['url']    = $this->create_action_link( $active['needs'], $slug );
			if ( $active['needs'] !== 'install' && $active['status'] ) {
				$futurio_storefront_recommended_plugin['class'] = 'active';
			} else {
				$futurio_storefront_recommended_plugin['class'] = '';
			}

			switch ( $active['needs'] ) {
				case 'install':
					$futurio_storefront_recommended_plugin['button_class'] = 'install-now button';
					$futurio_storefront_recommended_plugin['button_label'] = $install_button_label;
					break;
				case 'activate':
					$futurio_storefront_recommended_plugin['button_class'] = 'activate-now button button-primary';
					$futurio_storefront_recommended_plugin['button_label'] = $activate_button_label;
					break;
				case 'deactivate':
					$futurio_storefront_recommended_plugin['button_class'] = 'deactivate-now button';
					$futurio_storefront_recommended_plugin['button_label'] = $deactivate_button_label;
					break;
			}
			$info   = $this->call_plugin_api( $slug );
			$futurio_storefront_recommended_plugin['id'] = $slug;
			$futurio_storefront_recommended_plugin['plugin_slug'] = $slug;

			if ( ! empty( $plugin_opt['description'] ) ) {
				$futurio_storefront_recommended_plugin['description'] = $plugin_opt['description'];
			} else {
				$futurio_storefront_recommended_plugin['description'] = $info->short_description;
			}

			$futurio_storefront_recommended_plugin['title'] = $info->name;

			$customize_plugins[] = $futurio_storefront_recommended_plugin;
