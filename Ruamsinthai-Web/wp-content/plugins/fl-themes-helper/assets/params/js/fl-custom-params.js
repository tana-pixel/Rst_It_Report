...
( function( $ ) {
    ...
    $('.fl_style,.list_style,.product_advantages_style,.map_style,.title_style_text,.gallery_style,.testimonial_style,.woo_product_banner_style,.woo_product_slider_style').bind('change keyup', function(e) {
