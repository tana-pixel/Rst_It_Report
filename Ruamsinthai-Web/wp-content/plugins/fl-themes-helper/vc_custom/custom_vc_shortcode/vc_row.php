...
// Top Decor
if ( ! empty( $decor_style ) and ($decor_style =='white-left')) {
    $wrapper_attributes[]   = 'data-row-decor="true"';
    $decor = '<div class="decor-white-left"></div>';
} elseif ( ! empty( $decor_style ) and ($decor_style =='white-right')){
    $wrapper_attributes[]   = 'data-row-decor="true"';
    $decor = '<div class="decor-white-right"></div>';
}elseif ( ! empty( $decor_style ) and ($decor_style =='main-left')){
    $wrapper_attributes[]   = 'data-row-decor="true"';
    $decor = '<div class="decor-main-cl-left"></div>';
} elseif ( ! empty( $decor_style ) and ($decor_style =='main-right')){
    $wrapper_attributes[]   = 'data-row-decor="true"';
    $decor = '<div class="decor-main-cl-right"></div>';
} else{
    $decor = '';
}

// Bottom Decor
if ( ! empty( $decor_style_bottom ) and ($decor_style_bottom =='white-left')) {
    $wrapper_attributes[]   = 'data-row-decor-bottom="true"';
    $decor_bottom = '<div class="decor-white-bottom-left"></div>';
}elseif ( ! empty( $decor_style_bottom ) and ($decor_style_bottom =='main-left')) {
    $wrapper_attributes[]   = 'data-row-decor-bottom="true"';
    $decor_bottom = '<div class="decor-main-cl-bottom-left"></div>';
}else{
    $decor_bottom = '';
}
