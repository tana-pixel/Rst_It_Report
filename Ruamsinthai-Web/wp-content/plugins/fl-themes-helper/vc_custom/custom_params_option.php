...
function fl_vc_after_init_actions()
    {
        ...
        $vc_row_animation_params = array(
            ...
            array(
                ...
                'heading'           => esc_html__('Row Decor Top', 'fl-themes-helper'),
                'param_name'        => 'decor_style',
                'value'		        => '',
                'dependency' => array(
                    'element'                    => 'full_width',
                    'value' => array(
                ...
                'options' => array(
                    ...
                    esc_html__('White Left', 'fl-themes-helper')               => 'white-left',
                    esc_html__('White Right', 'fl-themes-helper')              => 'white-right',
                    esc_html__('Main Color Left', 'fl-themes-helper')          => 'main-left',
                    esc_html__('Main Color Right', 'fl-themes-helper')         => 'main-right',
                ),
                'group' => 'Style'
            ),
            ...
            array(
                'type'              => 'fl_radio_advanced',
                'heading'           => esc_html__('Row Decor Bottom', 'fl-themes-helper'),
                'param_name'        => 'decor_style_bottom',
                'value'		        => '',
                'dependency' => array(
                    'element'                    => 'full_width',
                    'value' => array(
