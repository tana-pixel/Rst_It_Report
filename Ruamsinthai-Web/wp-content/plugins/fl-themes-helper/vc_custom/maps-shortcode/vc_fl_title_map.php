...
//Title Typography
                    ...
                    array(
                        ...
                        'value'		        => 'fl-font-style-bolt',
                        'options' => array(
                            esc_html__('Default', 'fl-themes-helper')                       => '',
                            esc_html__('Title Style', 'fl-themes-helper')                   => 'fl-text-title-style',
                            esc_html__('Bolt', 'fl-themes-helper')                          => 'fl-font-style-bolt',
                            esc_html__('Bolt Two', 'fl-themes-helper')                      => 'fl-font-style-bolt-two',
                            esc_html__('Semi Bolt', 'fl-themes-helper')                     => 'fl-font-style-semi-bolt',
                            esc_html__('Regular One', 'fl-themes-helper')                   => 'fl-font-style-regular',
                            esc_html__('Regular Two ', 'fl-themes-helper')                  => 'fl-font-style-regular-two',
                        ),
                        'group'				=> esc_html__('Typography', 'fl-themes-helper'),
                    ),
                    array(
