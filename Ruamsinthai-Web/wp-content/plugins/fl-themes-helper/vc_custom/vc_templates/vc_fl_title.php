...
if ( ! function_exists( 'vc_fl_title_function' ) ) {
    function vc_fl_title_function($atts, $content = null)
    {
        ...
        if ( ! empty($title_style_text ) and ($title_style_text =='title_default')) {
            ...
            $title_css_classes [] = 'vc-custom-title font-text';
            $subtitle_css_classes []= 'vc-custom-sub-title back-text';
        }
        ...
        if (isset($subtitle_options['style']) && $subtitle_options['style'] != ''
            ...
            $fl_helping_css_style[] = ( $subtitle_options['style'] || $subtl_cl || $subtl_mt || $subtl_mb ) ? '.' . $custom_subtitle_class . ' {'. $subtl_cl . $subtl_mt . $subtl_mb .$subtitle_options['style'] .  '}' : '';
        }
        ...
        if(isset($title_style_text) && $title_style_text == 'title_default'){
            ...
            if(isset($content) && $content != ''){
                ...
                $result .= '<div class="' . esc_attr( trim( $title_class ) ) . '" '. implode( ' ', $title_wrapper_attributes ).'>';
        ...
        if(isset($title_style_text) && $title_style_text == 'custom-title'){
            ...
            if(isset($content) && $content != ''){
                ...
                $result .= '<div class="' . esc_attr( trim( $title_class ) ) . '" '. implode( ' ', $subtitle_wrapper_attributes ).'>';
