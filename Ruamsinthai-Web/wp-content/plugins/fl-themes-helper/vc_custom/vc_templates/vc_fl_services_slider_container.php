<?php
if ( ! function_exists( 'vc_fl_services_slider_container_function' ) ) {
    function vc_fl_services_slider_container_function($atts, $content = null)
    {
        $css_classes[] = 'fl-services-slider-container-content';

        global $fl_helping_responsive_style;

        $atts = vc_map_get_attributes('vc_fl_services_slider_container', $atts);
...
add_shortcode('vc_fl_services_slider_container', 'vc_fl_services_slider_container_function');