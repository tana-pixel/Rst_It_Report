 ...
 * */
if ( ! function_exists( 'vc_fl_work_info_row_function' ) ) {
    function vc_fl_work_info_row_function($atts, $content = null)
    {
        ...
        $atts = vc_map_get_attributes('vc_fl_work_info_row', $atts);
        ...
        $result .= '<div class="fl-right-content fl-work-info-content fl-font-style-light">' . wpb_js_remove_wpautop($content, true) . '</div>';
