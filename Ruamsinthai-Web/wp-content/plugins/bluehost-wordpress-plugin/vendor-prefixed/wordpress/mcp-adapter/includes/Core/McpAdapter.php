 ...
 *
 * @package \Bluehost\Plugin\WP\MCP\Core
 */
declare (strict_types=1);
namespace Bluehost\Plugin\WP\MCP\Core;

use Bluehost\Plugin\WP\MCP\Abilities\DiscoverAbilitiesAbility;
use Bluehost\Plugin\WP\MCP\Abilities\ExecuteAbilityAbility;
use Bluehost\Plugin\WP\MCP\Abilities\GetAbilityInfoAbility;
use Bluehost\Plugin\WP\MCP\Cli\McpCommand;
...
final class McpAdapter
{
     ...
     * Registry instance
     *
     * @var \Bluehost\Plugin\WP\MCP\Core\McpAdapter
     */
     ...
     *
     * @return \Bluehost\Plugin\WP\MCP\Core\McpAdapter
     */
     ...
     * @param class-string<\Bluehost\Plugin\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface> $error_handler The error handler class name. If null, NullMcpErrorHandler will be used.
     * @param class-string<\Bluehost\Plugin\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface> $observability_handler The observability handler class name. If null, NullMcpObservabilityHandler will be used.
     ...
     *
     * @return \Bluehost\Plugin\WP\MCP\Core\McpAdapter|\WP_Error McpAdapter instance on success, WP_Error on failure.
     */
     ...
     *
     * @return \Bluehost\Plugin\WP\MCP\Core\McpServer|null
     */
     ...
     *
     * @return \Bluehost\Plugin\WP\MCP\Core\McpServer[]
     */
