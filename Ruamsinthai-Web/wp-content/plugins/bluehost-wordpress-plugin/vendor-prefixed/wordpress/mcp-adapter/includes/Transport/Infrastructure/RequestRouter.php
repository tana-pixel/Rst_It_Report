...
use Bluehost\Plugin\WP\MCP\Infrastructure\ErrorHandling\McpErrorFactory;
...
class RequestRouter {
	 ...
	 *
	 * @var \Bluehost\Plugin\WP\MCP\Transport\Infrastructure\McpTransportContext
	 */
	 ...
	 *
	 * @param \Bluehost\Plugin\WP\MCP\Transport\Infrastructure\McpTransportContext $context The transport context.
	 */
	 ...
	 * @param \Bluehost\Plugin\WP\MCP\Transport\Infrastructure\HttpRequestContext|null $http_context HTTP context for session management.
	 *
	 * @return array
	 */
