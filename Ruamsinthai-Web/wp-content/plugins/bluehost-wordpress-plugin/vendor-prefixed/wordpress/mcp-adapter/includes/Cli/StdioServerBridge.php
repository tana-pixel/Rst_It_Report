...
namespace Bluehost\Plugin\WP\MCP\Cli;

use Bluehost\Plugin\WP\MCP\Core\McpServer;
use Bluehost\Plugin\WP\MCP\Transport\Infrastructure\RequestRouter;
...
class StdioServerBridge {
	 ...
	 *
	 * @var \Bluehost\Plugin\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
	 ...
	 *
	 * @param \Bluehost\Plugin\WP\MCP\Core\McpServer $server The MCP server to expose.
	 */
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
