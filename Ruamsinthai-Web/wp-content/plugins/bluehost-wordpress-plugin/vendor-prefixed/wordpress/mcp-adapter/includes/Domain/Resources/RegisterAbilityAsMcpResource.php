...
namespace Bluehost\Plugin\WP\MCP\Domain\Resources;
...
class RegisterAbilityAsMcpResource {
	 ...
	 * @param \Bluehost\Plugin\WP\MCP\Core\McpServer $mcp_server The MCP server.
	 *
	 * @return \Bluehost\Plugin\WP\MCP\Domain\Resources\McpResource|\WP_Error Returns resource instance or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\MCP\Domain\Resources\McpResource|\WP_Error Returns the MCP resource instance or WP_Error if validation fails.
	 */
