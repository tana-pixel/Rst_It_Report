...
namespace Bluehost\Plugin\WP\MCP\Transport;

use Bluehost\Plugin\WP\MCP\Transport\Contracts\McpRestTransportInterface;
use Bluehost\Plugin\WP\MCP\Transport\Infrastructure\HttpRequestContext;
use Bluehost\Plugin\WP\MCP\Transport\Infrastructure\HttpRequestHandler;
use Bluehost\Plugin\WP\MCP\Transport\Infrastructure\McpTransportContext;
use Bluehost\Plugin\WP\MCP\Transport\Infrastructure\McpTransportHelperTrait;
...
class HttpTransport implements McpRestTransportInterface {
	 ...
	 *
	 * @var \Bluehost\Plugin\WP\MCP\Transport\Infrastructure\HttpRequestHandler
	 */
	 ...
	 *
	 * @param \Bluehost\Plugin\WP\MCP\Transport\Infrastructure\McpTransportContext $transport_context The transport context.
	 */
