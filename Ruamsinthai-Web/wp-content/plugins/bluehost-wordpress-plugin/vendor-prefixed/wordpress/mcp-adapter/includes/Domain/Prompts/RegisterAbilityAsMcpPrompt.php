...
namespace Bluehost\Plugin\WP\MCP\Domain\Prompts;
...
class RegisterAbilityAsMcpPrompt {
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\MCP\Domain\Prompts\McpPrompt|\WP_Error Returns prompt instance or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\MCP\Domain\Prompts\McpPrompt|\WP_Error MCP prompt instance or WP_Error if validation fails.
	 */
