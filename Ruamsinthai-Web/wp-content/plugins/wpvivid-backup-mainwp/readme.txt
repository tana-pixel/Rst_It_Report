...
- Fixed: Redirection to a child site would fail when white label slug of the site contained capital letters.
- Fixed: Activating WPvivid license would fail in some cases.
= 0.9.37 =
